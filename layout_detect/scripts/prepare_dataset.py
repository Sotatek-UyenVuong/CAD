...
SOURCE_FOLDERS: list[str] = [
    ...
    "rendered_総合設計制度の手引き・事例集_dpi300",
    "rendered_2024入社説明会(第1設計統括室_住宅)_dpi300",
    "rendered_TLC_BZ商品計画テキスト2014_dpi300",
]

CLASSES: list[str] = ["text", "table", "title_block", "diagram", "image"]

DROP_CLASS_IDS: set[int] = set()
CLASS_ID_REMAP: dict[int, int] = {0: 0, 1: 1, 2: 2, 3: 3, 4: 4}
